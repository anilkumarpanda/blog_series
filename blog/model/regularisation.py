...
def select_features(data_dict):
    ...
    step2 = {'Correlated Features': {'correlation_threshold': 0.90}}
    
    step3 = {'Relevant Features': {'estimator': clf,
                                   'cv': 5,
                                    'n_estimators': 100,
                                    'max_iter': 100,
                                    'verbose': 50,
    ...
    step4 = {'RFECV Features': {'estimator': clf,
                                'cv': 2,
                                'step': 1,
                                'scoring': 'roc_auc',
                                'verbose': 50,}}
    ...
    fs.fit(data_dict['xtrain'], data_dict['ytrain'], steps)

    data_dict['xtrain']=fs.transform(data_dict['xtrain'])
    data_dict['xtest']=fs.transform(data_dict['xtest'])
