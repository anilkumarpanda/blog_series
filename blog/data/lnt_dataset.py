...
class LnTDataset:
    ...
    def _finance_age(self):
        ...
        """
        self.df["AVERAGE.ACCT.AGE"] = self.df["AVERAGE.ACCT.AGE"].apply(
            self._string_age
        )
        self.df["CREDIT.HISTORY.LENGTH"] = self.df["CREDIT.HISTORY.LENGTH"].apply(
            self._string_age
        )
    ...
    def _map_credit_risk(self):
        ...
        self.df["PERFORM_CNS.SCORE.DESCRIPTION"].replace(
            {
    ...
    def _map_employment(self):
        ...
        self.df["Employment.Type"] = self.df["Employment.Type"].apply(
